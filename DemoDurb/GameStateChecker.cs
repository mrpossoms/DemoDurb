...
namespace DemoDurb
{
    ...
    public class GameStateChecker : Microsoft.Xna.Framework.GameComponent
    {
        ...
        public static void updateModeTag(GameTime gt)
        {
            if (Game1.cars.cars.Count > 1)
            {
                if (it != null)
                {
                    ...
                    if (Math.Abs(gt.TotalGameTime.Seconds - becameIt) >= 10)
                    {
        ...
        private static void selectIt()
        {
            ...
            becameIt = _gameTime.TotalGameTime.Seconds;
        ...
        {
            float prog = (float)((20f - (_gameTime.TotalGameTime.Seconds - becameIt)) / 20f);
            return prog;
        } 
        #endregion
